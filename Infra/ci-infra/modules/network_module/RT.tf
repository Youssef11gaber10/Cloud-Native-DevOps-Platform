...
resource "aws_route_table" "public_route_table_ci_vpc" {
  ...
  # }
  tags = {
    Name = "public_route_table_ci_vpc"
  }
}

resource "aws_route_table" "private_route_table_ci_vpc" {
  vpc_id = aws_vpc.ci_vpc.id
  # route {
  #     cidr_block = "0.0.0.0/0"
  ...
  # }
  tags = {
    Name = "private_route_table_ci_vpc"
  }
...
resource "aws_route_table_association" "private_subnet_association_ci_vpc" {
